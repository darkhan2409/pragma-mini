...
# Режим воспроизводимости MKL — до первого вызова BLAS. Без него
# sgemm считает по-разному в зависимости от выравнивания входа:
# строка календаря из 6 чисел занимает 24 байта, и одна и та же
# строка на чётной и нечётной позиции даёт разный последний бит.
# Побитовые проверки изоляции ловили бы тогда раскладку памяти, а
# не утечку.
