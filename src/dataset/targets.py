...
# Masker.
#
# Период — окно маскирования группы в настройках препроцессинга
# (GroupWindow), и правило одно: [target_start, target_end) —
# начало включено, конец нет. Вторая реализация «того же самого»
# рано или поздно разошлась бы с первой на границе. События вне
# окна остаются контекстом примера.
#
