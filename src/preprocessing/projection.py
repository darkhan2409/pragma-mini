...
SEMANTIC_PAYLOAD_FIELDS: dict[str, str] = {
    ...
    "product_family": "семейство продукта",
    "product_version": "версия условий продукта",
...
# Значения, которые нужно вывести из справочника, из связи или из
# расчёта, добавляет смысловой слой — и объявляет их такими же
# ключами, как физические поля.
#
...
SEMANTIC_LAYER_FIELDS: dict[str, str] = {
    "product_name": "название продукта по справочнику в версии, названной событием",
    "previous_product_name": "название прежнего продукта при переходе",
    "previous_product_family": "семейство прежнего продукта при переходе",
    "merchant_brand": "бренд сети по справочнику мерчантов",
    "merchant_sector": "сектор точки по справочнику мерчантов",
    "merchant_category": "категория точки по справочнику мерчантов",
    "merchant_subcategory": "подкатегория точки по справочнику мерчантов",
    "outlet_region": "регион точки по справочнику мерчантов",
    "outlet_district": "район точки по справочнику мерчантов",
    "outlet_settlement_type": "тип населённого пункта точки",
    "outlet_channel": "канал обслуживания точки",
    "outlet_price_segment": "ценовой сегмент точки",
    ...
    "same_merchant": "та же точка, что и у события-причины",
