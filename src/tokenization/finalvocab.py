...
#
# Номер у значения свой на каждый ключ: одинаковая запись у
# разных ключей это разные факты, и общего номера у них нет.
# Поэтому имя в словаре и номер соответствуют друг другу один
# к одному.
#
