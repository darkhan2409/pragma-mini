...
MLM</code>. Сохранённые файлы этапов 09–12 входом не служат — из них взяты
только веса, чтобы отчёт был сопоставим со снимками. Градиент от потерь доходит
до общей таблицы эмбеддингов и всех трёх энкодеров.</p>
